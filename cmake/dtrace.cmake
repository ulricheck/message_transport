...
MACRO (DTRACE_HEADER provider header header_no_dtrace)
 ...
 ADD_CUSTOM_COMMAND(
   ...
   COMMAND perl ${CMAKE_CURRENT_SOURCE_DIR}/tracing/dtrace/dheadgen.pl -f ${provider} > ${header_no_dtrace}
   DEPENDS ${provider}
 )
 ENDIF()
ENDMACRO()
...
IF(ENABLE_DTRACE)
  CONFIGURE_FILE(${CMAKE_CURRENT_SOURCE_DIR}/tracing/dtrace/probes_message_transport.d.base
    ${CMAKE_BINARY_DIR}/tracing/dtrace/probes_message_transport.d COPYONLY)
  DTRACE_HEADER(
   ${CMAKE_BINARY_DIR}/tracing/dtrace/probes_message_transport.d
   ${CMAKE_BINARY_DIR}/tracing/dtrace/probes_message_transport_dtrace.h
   ${CMAKE_BINARY_DIR}/tracing/dtrace/probes_message_transport_nodtrace.h
  )
...
FUNCTION(DTRACE_INSTRUMENT target)
  ...
  IF(ENABLE_DTRACE)
    ...
    IF(CMAKE_SYSTEM_NAME MATCHES "SunOS")
      ...
      ADD_CUSTOM_COMMAND(
        ...
        COMMAND ${CMAKE_COMMAND}
          -DDTRACE=${DTRACE}	  
          -DOUTFILE=${outfile} 
          -DDFILE=${CMAKE_BINARY_DIR}/tracing/dtrace/probes_message_transport.d
    ...
    ELSEIF(CMAKE_SYSTEM_NAME MATCHES "Linux")
      ...
      SET(outfile "${CMAKE_BINARY_DIR}/probes_message_transport.o")
      # Systemtap object
      EXECUTE_PROCESS(
        COMMAND ${DTRACE} -G -s ${CMAKE_BINARY_DIR}/tracing/dtrace/probes_message_transport.d
        -o ${outfile}
        )
